...
url: https://prod.alltrue-be.com/_docs/docs/integration_examples/copilot_studio
...
Note: Unlike the [LiteLLM integration](/_docs/platform_services/litellm.md), Copilot Studio's threat detection webhook does not support content modification (e.g., PII redaction). If a rule would modify content, TRiSM Hub treats this as a block to prevent unmodified sensitive data from reaching the tool.
