...
url: https://prod.alltrue-be.com/_docs/docs/release_notes/311
...
- Prevent Jailbreak now includes sensitivity toggles and customizable behaviors.
- New agentic guardrails for:
...
Added support for the NIST AI RMF – Organizational Profile, enabling organizational-level compliance assessments separate from the AI Systems audit.

### Pentest Enhancements[​](#pentest-enhancements)
Improved request concurrency for faster runs and enhanced support for reasoning models with longer response times. Added 6 new categories—Excessive Permissions, Excessive Functionality, Excessive Autonomy, Internal Instructions, Safety Filters, and Secrets &amp; Credentials—for LLM and Agent Pentesting.
