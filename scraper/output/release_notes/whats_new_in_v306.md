...
url: https://prod.alltrue-be.com/_docs/docs/release_notes/306
...
[PreviousWhat's New in V3.0.7](/_docs/docs/release_notes/307)[NextWhat's New in V3.0.5](/_docs/docs/release_notes/305)- [Compliance Knowledge Hub](#compliance-knowledge-hub)- [LLM Quarantine](#llm-quarantine)- [Pentest Customization](#pentest-customization)- [Pentest Result Comparisons](#pentest-result-comparisons)- [Guardrails Enhancements](#guardrails-enhancements)- [Project Metadata and Attachments](#project-metadata-and-attachments)
