...
[PreviousAnthropic OTEL Logs](/_docs/docs/log_sources/anthropic_otel)[NextShadow AI Usage Monitoring](/_docs/docs/shadow_ai_usage_monitoring/overview)- [Before you start](#before-you-start)- [How ingestion works](#how-ingestion-works)- [Add an AWS Bedrock log source](#add-an-aws-bedrock-log-source)- [Offline evaluation and where events appear](#offline-evaluation-and-where-events-appear)- [Related](#related)
