---
title: Copilot events from Varonis Data Security Platform
url: https://prod.alltrue-be.com/_docs/docs/log_sources/copilot_varonis_dspm
section: log_sources
---

# Copilot events from Varonis Data Security Platform

- [](/_docs/)- [Log Sources](/_docs/docs/log_sources/overview)- Copilot events from Varonis Data Security PlatformExport PDFOn this page# Copilot events from Varonis Data Security Platform
This Log Source pulls **Microsoft 365 Copilot** prompt and response events from a **Varonis Data Security Platform** tenant — via the Varonis **Export API** — into Atlas for offline runtime-policy evaluation, alerting, and a unified investigation view. It is for Varonis Data Security Platform customers who want their Microsoft 365 Copilot activity monitored alongside the rest of their AI usage in Atlas.
...
In **Admin Console &gt; System Settings &gt; Log Sources**, click **Add New Integration** and select the **Copilot events from Varonis Data Security Platform** card. Supply the **Tenant Base URL** and **API Key** you collected above.
...
The data plane pulls Microsoft 365 Copilot **prompt and response events** from your Varonis Data Security Platform tenant on a schedule, and Atlas evaluates them offline against your configured runtime policies. Because the activity is evaluated after the fact, policy actions configured to **BLOCK** or **MODIFY** are surfaced as **ALERTs** — Atlas cannot intercept the request in flight.
...
[PreviousAnthropic Compliance API](/_docs/docs/log_sources/anthropic_compliance_api)[NextChatGPT Enterprise events from Varonis Data Security Platform](/_docs/docs/log_sources/chatgpt_enterprise_varonis_dspm)- [Before you begin](#before-you-begin)- [Generate an API key](#generate-an-api-key)- [Add the integration](#add-the-integration)- [What gets ingested and how it is evaluated](#what-gets-ingested-and-how-it-is-evaluated)- [Troubleshooting](#troubleshooting)
