...
- **Discovery** — Atlas discovers your Copilot Studio agents, their components, tools, connectors, and authentication configurations across all Power Platform environments.
...
Note: Unlike the [LiteLLM integration](/_docs/docs/integration_examples/litellm), Copilot Studio's threat detection webhook does not support content modification (e.g., PII redaction). If a rule would modify content, Atlas treats this as a block to prevent unmodified sensitive data from reaching the tool.
