...
function LoginForm() {
  ...
  const SUPERUSERS = ["ttadeo@timthecoder.net", "khuram.work@gmail.com", "jsl@jeffscottlevine.com"];
    ...
    <div className="flex flex-col h-screen bg-gray-950 text-gray-100 items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl px-6 py-8">
          {step === "password" ? (
            <>
              <h2 className="text-sm font-semibold text-gray-300 mb-2 text-center">Enter your password</h2>
              <p className="text-xs text-gray-500 mb-6 text-center">
                Signing in as <span className="text-gray-300">{email}</span>
              </p>
